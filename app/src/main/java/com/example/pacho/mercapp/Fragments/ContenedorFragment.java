package com.example.pacho.mercapp.Fragments;
...
import com.example.pacho.mercapp.Adaptadores.SeccionesAdapter;
...
public class ContenedorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (Utilidades.rotacion==0){
            ...
            if (appBar==null){
                ...
                viewPager= (ViewPager) vista.findViewById(R.id.idContenedorTabs);
    ...
    private void llenarViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ProductoFragment(),"Productos");
